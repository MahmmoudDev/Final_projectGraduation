                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4">
                        <div class="booking-card">
                            @if ($lawyer->image)
                                <img src="{{ asset('storage/lawyers/' . $lawyer->image) }}" alt="specialization Image"
                            ...
                            <h3 class="mt-4">{{ $lawyer->name }}</h3>

                            <p class="booking-speciality">{{ $lawyer->specialization->name }}</p>
                    ...
                    <div class="col-lg-8">
                        <div class="booking-form-box">
                            ...
                            <form method="POST" action="{{ route('front.booking_lawyer', $lawyer->id) }}">
